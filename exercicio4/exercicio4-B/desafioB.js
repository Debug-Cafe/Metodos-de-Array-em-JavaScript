...
const lowPriorityAndComplet = tasks.some((task) => task.priority === "baixa" && task.completed === true);

console.log(`Pelo menos uma tarefa da lista é de prioridade baixa e está completa.\nPois está retornando o valor: ${lowPriorityAndComplet}`);