// Encontrando a primeira tarefa incompleta
...
const taskIncomplet = tasks.findIndex((task) => task.completed === false);

console.log(`A primeira tarefa incompleta encontrada esta na posição: ¨${taskIncomplet}`);
